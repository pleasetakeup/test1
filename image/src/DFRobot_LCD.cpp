...
void DFRobot_ILI9341_240x320_HW_SPI::pushColor(uint16_t color,uint32_t size){
  sendColor(color, size);
}
...
void DFRobot_ST7789_240x240_HW_SPI::pushColor(uint16_t color,uint32_t size){
  sendColor(color, size);
}
...
void DFRobot_ST7789_240x320_HW_SPI::pushColor(uint16_t color,uint32_t size){
  sendColor(color, size);
}
...
void DFRobot_ST7735S_80x160_HW_SPI::pushColor(uint16_t color,uint32_t size){
  sendColor(color, size);
}
...
void DFRobot_ILI9488_320x480_HW_SPI::pushColor(uint16_t color,uint32_t size){
  uint8_t rgb666[3];
  //Serial.println(size);
  rgb565ToRGB666(rgb666, color);
  sendColor(rgb666, 3, size);
}
...
void DFRobot_SSD1306_128x32_HW_IIC::pushColor(uint16_t color,uint32_t size){
  //sendColor(color, size);
...
void DFRobot_ST7789_240x240_DMA_SPI::pushColor(uint16_t color,uint32_t size){
  sendColor(color, size);
}
...
void DFRobot_ST7735S_80x160_DMA_SPI::pushColor(uint16_t color,uint32_t size){
  sendColor(color, size);
}
...
void DFRobot_ST7789_240x320_DMA_SPI::pushColor(uint16_t color,uint32_t size){
  sendColor(color, size);
}
...
void DFRobot_ILI9488_320x480_DMA_SPI::pushColor(uint16_t color,uint32_t size){
  uint8_t rgb666[3];
  rgb565ToRGB666(rgb666, color);
  sendColor(rgb666, sizeof(rgb666), size);
}
...
void DFRobot_ILI9341_240x320_DMA_SPI::pushColor(uint16_t color,uint32_t size){
  sendColor(color, size);
}
#endif//end M0
